...
const config: Config = {
  ...
  // The name of your repository as the base pathname
  ...
  markdown: {
    mermaid: true, // Enables Mermaid diagrams [cite: 212, 338, 446]
  },
    ...
    [
      'classic',
      {
        docs: {
          ...
          // Enables LaTeX math rendering [cite: 190, 192]
  ...
  // Required for KaTeX CSS (LaTeX math styling)
  stylesheets: [
    {
